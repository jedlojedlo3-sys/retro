...
export const translations = {
  mk: {
    ...
    // Reserve Modal
    modal_title: 'Резервација во продавница',
    modal_friendly_badge: '✨ Бесплатна резервација · 48 часа за проба',
    modal_friendly_subtitle: 'Остави име и телефон. Парчето веднаш го тргаме на страна за тебе во Prilep!',
    modal_size_label: 'Големина',
    modal_qty_label: 'Количина',
    modal_item_singular: 'парче',
    modal_item_plural: 'парчиња',
    modal_name_label: 'Твоето име',
    modal_name_placeholder: 'Пр. Марко',
    modal_phone_label: 'Телефонски број за контакт',
    modal_phone_placeholder: '07x xxx xxx',
    modal_email_label: 'Е-пошта',
    modal_email_optional: '(опционално)',
    modal_notice: 'Без онлајн плаќање. Плаќањето се врши при подигнување и проба во продавницата во Prilep (Stiv Naumov 8).',
    modal_total: 'Вкупно:',
    modal_cancel: 'Затвори',
    modal_confirm: 'Потврди резервација',
    modal_processing: 'Се зачувува...',
    modal_whatsapp_btn: 'Резервирај директно на WhatsApp',
    modal_success_title: 'Твојата резервација е спремна!',
    modal_success_desc: 'Моделот е тргнат на страна за тебе и те чека во Retro Boutique во Prilep (Stiv Naumov 8) следните 48 часа.',
    modal_success_ticket: 'Број на резервација:',
    modal_continue_shopping: 'Продолжи со разгледување',
    modal_open_maps: 'Отвори на Google Maps',
    err_select_size: 'Ве молиме изберете големина.',
    err_enter_name: 'Ве молиме внесете го вашето име.',
    err_enter_phone: 'Ве молиме внесете телефонски број.',
  ...
  en: {
    ...
    // Reserve Modal
    modal_title: 'Store Hold & Fitting',
    modal_friendly_badge: '✨ Free Store Hold · 48h to try on',
    modal_friendly_subtitle: 'Leave your name and phone. We immediately hold this piece for you in Prilep!',
    modal_size_label: 'Size',
    modal_qty_label: 'Quantity',
    modal_item_singular: 'piece',
    modal_item_plural: 'pieces',
    modal_name_label: 'Your Name',
    modal_name_placeholder: 'E.g. Marko',
    modal_phone_label: 'Contact Phone Number',
    modal_phone_placeholder: '07x xxx xxx',
    modal_email_label: 'Email',
    modal_email_optional: '(optional)',
    modal_notice: 'No upfront online payment. You only pay when trying on and picking up at our store in Prilep (Stiv Naumov 8).',
    modal_total: 'Total:',
    modal_cancel: 'Close',
    modal_confirm: 'Confirm Free Hold',
    modal_processing: 'Saving...',
    modal_whatsapp_btn: 'Reserve directly on WhatsApp',
    modal_success_title: 'Your Piece is Held!',
    modal_success_desc: 'Set aside for you at Retro Boutique in Prilep (Stiv Naumov 8) for the next 48 hours.',
    modal_success_ticket: 'Hold Ticket Code:',
    modal_continue_shopping: 'Continue Browsing',
